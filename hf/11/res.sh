...
if [ -e "$rif.out" ]; then
	...
	f(x)=a*x+b*x**2+c*x**3+d*x**4+e*x**5#+f*x**6+g*x**7+h*x**8+i*x**9+l*x**10+m*x**11+n*x**12+o*x**13+p*x**14+q*x**15
      #e=$minenkj
      #r=$eqdist
	a=b=c=d=e=f=g=h=i=l=m=n=o=p=q=r=s=1
      fit [0.5:1.1] f(x) '${graph2}' using 1:2 via a,b,c,d,e#,f,g,h,i,l,m,n,o,p,q
